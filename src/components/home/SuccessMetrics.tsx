        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {successMetricsSection.metrics.map((metric, index) => (
            ...
            >
              ...
              {/* Render the real value as static text so search engines, AI
                  crawlers, and the prerenderer always capture the true number
                  (the previous CountUp animation was captured at frame 0 = "0%"). */}
